...
exports.run = (client, message, args) => {
  ...
  if (reason.length < 1) return message.reply('niye banlıyon adamı onu yazaydın.');
  if (message.mentions.users.size < 1) return message.reply('kimi banlicam onu yaz.').catch(console.error);
